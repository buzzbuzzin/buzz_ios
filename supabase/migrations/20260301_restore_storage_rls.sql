-- ============================================================
-- RESTORE: Re-enable secure folder-based storage RLS policies
-- ============================================================
-- Run this AFTER all users have updated to the new app version
-- that uses lowercased UUIDs in storage paths.
--
-- This replaces the permissive policies (any authenticated user)
-- with secure ones that enforce per-user folder isolation via
-- LOWER(foldername) = auth.uid().
-- ============================================================
