-- Migration: Exempt Flight Reviewer Buzz courses from Academy Pass enrollment requirement
...
BEGIN
    ...
    IF normalized_course_title IN ('uas pilot', 'rpas pilot', 'roc a')
       OR normalized_course_title LIKE '%flight reviewer%' THEN
        RETURN true;
    END IF;
