//
//  HelpCenterArticleComponents.swift
//  Buzz
//
//  Extracted from HelpView.swift to allow reuse across modules.
//

import SwiftUI

enum HelpCenterCategory: String, CaseIterable, Identifiable {
    case gettingStarted
    case bookings
    case credentials
    case academy
...
struct HelpCenterArticle: Identifiable {
    let id: String
    let title: String
    let summary: String
    let icon: String
    ...
    static func article(withId id: String) -> HelpCenterArticle? {
        library.first { $0.id == id }
    }
}

struct HelpCenterArticleSection: Identifiable {
    let id = UUID()
    let title: String
...
struct HelpCenterArticleDetailView: View {
...
struct HelpCenterArticleSectionCard: View {
