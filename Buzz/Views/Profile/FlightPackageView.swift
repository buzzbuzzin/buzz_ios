        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Text("Turn every car into a commercial. With 50 videos per month, your inventory shines like never before. On average, members save over $2,000 per month compared to on-demand shoots.")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                        .multilineTextAlignment(.center)
        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Subscribe Buzz Auto Package")
                        .font(.title2)
                        .fontWeight(.bold)
                    ...
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        HStack(alignment: .top, spacing: 12) {
                            Image(systemName: "bolt.fill")
                                ...
                                .frame(width: 32)
                            VStack(alignment: .leading, spacing: 8) {
                                Text("Up to 50 videos per month")
                                    .font(.headline)
                                    .foregroundColor(.primary)
                                VStack(alignment: .leading, spacing: 4) {
                                    Text("Full editing and post-production included.")
